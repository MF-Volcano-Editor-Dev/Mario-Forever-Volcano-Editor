...
const EnemyAttacked := preload("res://objects/#components/enemy_related/scripts/enemy_attacked.gd")
const EnemyBody := preload("res://objects/#components/enemy_related/scripts/enemy_body.gd")
const EnemyStompedProcessor := preload("res://objects/entities/enemies/#components/scripts/enemy_stomped_processor.gd")
