...
const _Scores: PackedScene = preload("res://objects/uis/counters/scores_label.tscn")
const _Lives: PackedScene = preload("res://objects/uis/counters/lives_label.tscn")
