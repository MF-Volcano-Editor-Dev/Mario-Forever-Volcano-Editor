...
@export_group("Sounds")
@export var sound_activate: AudioStream = preload("res://assets/sounds/appear.wav")
@export var sounds_checkpoint: Array[AudioStream] = [
	preload("res://assets/sounds/voice1.ogg"),
	preload("res://assets/sounds/voice2.ogg"),
	preload("res://assets/sounds/voice3.ogg"),
]
