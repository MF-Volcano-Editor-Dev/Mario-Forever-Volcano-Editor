...
const _LakituDeath := preload("res://scripts/entities/enemies/#death/lakitu_death.gd")
...
@export var sounds_lakitu: Array[AudioStream] = [
	preload("res://assets/sounds/lakitu_mek.ogg"),
	preload("res://assets/sounds/lakitu_rek.ogg"),
