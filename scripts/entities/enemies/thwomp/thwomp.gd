...
@export var explosion_effect: PackedScene = preload("res://objects/entities/#effects/explosion_fire.tscn")
...
@export var sound_stun: AudioStream = preload("res://assets/sounds/stun.wav")
@export var sound_laugh: AudioStream = preload("res://assets/sounds/laughing.wav")
